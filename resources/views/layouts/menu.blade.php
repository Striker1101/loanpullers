 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
     ...
     <div class="sidebar">
         ...
         <nav class="mt-2">
             ...
             <li class="nav-item">
                 <a href="#" class="nav-link {{ request()->routeIs('budget_categories.*') ? 'active' : '' }}">
                     <i class="nav-icon fas fa-calculator"></i>
                     <p>
                         Budget
                         <i class="fas fa-angle-left right"></i>
                 ...
                 <ul class="nav nav-treeview">
                     ...
                     <li class="nav-item">
                         <a href="" class="nav-link {{ request()->routeIs('budgets.csv') ? 'active' : '' }}">
                             <i class="far fa-circle nav-icon"></i>
             ...
             <li class="nav-item">
                 ...
                 <ul class="nav nav-treeview">
                     ...
                     <li class="nav-item">
                         <a href="" class="nav-link {{ request()->routeIs('branch.index') ? 'active' : '' }}">
                             <i class="far fa-circle nav-icon"></i>
                             <p>Manage Branches</p>
                         </a>
                     </li>
                     ...
                     <li class="nav-item">
                         <a href="" class="nav-link {{ request()->routeIs('logs.index') ? 'active' : '' }}">
                             <i class="far fa-circle nav-icon"></i>
                             <p>User Activity</p>
                         </a>
                     </li>
