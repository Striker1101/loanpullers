@include('layouts.header', ['location' => 'show ' . $borrower->first_name])
                    ...
                    <div class="col">
                        <nav aria-label="breadcrumb" class="bg-light rounded-3 p-3 mb-4">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> Borrower Profile</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="card mb-4">
                            <div class="card-body text-center">
                                @if (auth()->user()->profilepic)
                                    <img src="{{ asset('attatchments_loans/' . auth()->user()->profilepic) }}"
                                        alt="avatar" class="rounded-circle img-fluid" style="width: 150px;">
                                @else
                                    <img src="{{ asset('avater.png') }}" alt="avatar" class="rounded-circle img-fluid"
                                        style="width: 150px;">
                                @endif
                                ...
                                <div class="d-flex justify-content-center mb-2">
                                    ...
                                    <button type="button" class="btn btn-outline-primary ms-1"><a
                                            href="mailto:{{ $borrower->email }}">Message</a></button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body p-0">
                            <ul class="list-group list-group-flush rounded-3">
                                <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                                    Net Salary/Income
                                    <p class="mb-0"> {{ $ipData['currency'] }}</p>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                                    Company/Ministry
                                    <p class="mb-0"></p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <p class="text-muted mb-0">
                                            {{ $borrower->first_name . ' ' . $borrower->last_name }}</p>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
